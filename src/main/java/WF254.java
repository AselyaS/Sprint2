...
public class WF254 {
    ...
    private By textField = By.xpath("/html/body/div[2]/section/div/div[2]/div/button");
    ...
    public void setUp() {
        ...
        System.out.println("Verify AU can search by filter with the Contains Text in Report page");
    ...
    public void test() throws Exception {
        ...
        FileUtils.copyFile(source, new File("./Screenshots/fitsWF254.png"));
