...
public class WF250 {
    ...
    private By textField = By.xpath("/html/body/div[2]/section/div/div[1]/div[1]/div[2]/div/input");
    ...
    public void setUp() {
        ...
        System.out.println("Verify AU can search by filter the Last Name in Report page");
    ...
    public void test() throws Exception {
        ...
        System.out.println("Type text in the \"Last Name\" field");

        TakesScreenshot ts =(TakesScreenshot)driver;
        File source = ts.getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(source, new File("./Screenshots/fitsWF250.png"));
